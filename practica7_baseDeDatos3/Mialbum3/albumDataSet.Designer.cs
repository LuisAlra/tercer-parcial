...
namespace Mialbum3 {
    ...
    public partial class albumDataSet : global::System.Data.DataSet {
        ...
        public partial class alumnoDataTable : global::System.Data.TypedTableBase<alumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public alumnoRow AddalumnoRow(int Boleta, string Nombre, string Email, byte[] Imagen, byte[] Video) {
        ...
        public partial class alumnoRow : global::System.Data.DataRow {
            ...
            public byte[] Video {
                get {
                    try {
                        return ((byte[])(this[this.tablealumno.VideoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Video\' in table \'alumno\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablealumno.VideoColumn] = value;
                }
            }
            ...
            public bool IsVideoNull() {
                return this.IsNull(this.tablealumno.VideoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetVideoNull() {
                this[this.tablealumno.VideoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Mialbum3.albumDataSetTableAdapters {
    ...
    public partial class alumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `alumno` (`Boleta`, `Nombre`, `Email`, `Imagen`, `Video`) VALUES (?, " +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `alumno` SET `Boleta` = ?, `Nombre` = ?, `Email` = ?, `Imagen` = ?, `Video" +
                "` = ? WHERE ((`Boleta` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?))" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Mialbum3.Properties.Settings.Default.albumConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Boleta, Nombre, Email, Imagen, Video FROM alumno";
        ...
        public virtual int Insert(int Boleta, string Nombre, string Email, byte[] Imagen, byte[] Video) {
        ...
        public virtual int Update(int Boleta, string Nombre, string Email, byte[] Imagen, byte[] Video, int Original_Boleta, string Original_Nombre, string Original_Email) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_Boleta));
            if ((Original_Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Email, byte[] Imagen, byte[] Video, int Original_Boleta, string Original_Nombre, string Original_Email) {
            return this.Update(Original_Boleta, Nombre, Email, Imagen, Video, Original_Boleta, Original_Nombre, Original_Email);
        }
    }
