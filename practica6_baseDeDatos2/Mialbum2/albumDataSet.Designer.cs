...
namespace Mialbum2 {
    ...
    public partial class albumDataSet : global::System.Data.DataSet {
        ...
        public partial class alumnoDataTable : global::System.Data.TypedTableBase<alumnoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public alumnoRow AddalumnoRow(int Boleta, string Nombre, string Email, byte[] Imagen) {
...
namespace Mialbum2.albumDataSetTableAdapters {
    ...
    public partial class alumnoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `alumno` (`Boleta`, `Nombre`, `Email`, `Imagen`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `alumno` SET `Boleta` = ?, `Nombre` = ?, `Email` = ?, `Imagen` = ? WHERE (" +
                "(`Boleta` = ?) AND ((? = 1 AND `Nombre` IS NULL) OR (`Nombre` = ?)) AND ((? = 1 " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Mialbum2.Properties.Settings.Default.albumConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Boleta, Nombre, Email, Imagen FROM alumno";
        ...
        public virtual int Insert(int Boleta, string Nombre, string Email, byte[] Imagen) {
        ...
        public virtual int Update(int Boleta, string Nombre, string Email, byte[] Imagen, int Original_Boleta, string Original_Nombre, string Original_Email) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Boleta));
            if ((Original_Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Email, byte[] Imagen, int Original_Boleta, string Original_Nombre, string Original_Email) {
            return this.Update(Original_Boleta, Nombre, Email, Imagen, Original_Boleta, Original_Nombre, Original_Email);
        }
    }
